...
export default function SixNineTrash() {
  ...
  const sixNineAnim = `${sixNineXFrames} ${height/200}s linear 0s infinite alternate, ${sixNineYFrames} ${calcHeightFrames()}s linear 0s infinite alternate`

  return <Image as={motion.img} animation={sixNineAnim} id="six-nine" src="sixninetrash.png" alt="trash" />;
}
